...
<div class="max-w-2xl mx-auto">
    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            <h2 class="card-title text-2xl font-bold mb-4">Edit Expense</h2>
            ...
            <form action="{{ route('expenses.update', $expense) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="form-control">
                        ...
                        <input type="datetime-local" name="transacted_at" id="transacted_at"
                               value="{{ old('transacted_at', $expense->transacted_at->format('Y-m-d\TH:i')) }}"
                ...
                <div class="form-control mb-4">
                    ...
                    <select name="person_id" id="person_id"
                        ...
                        @foreach ($people as $person)
                            <option value="{{ $person->id }}" {{ old('person_id', $expense->person_id) == $person->id ? 'selected' : '' }}>
                ...
                <x-tag-selector :tags="$tags" :selected="$expense->tags->pluck('id')->toArray()" />
