...
<div class="max-w-2xl mx-auto">
    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            <h2 class="card-title text-2xl font-bold mb-4">Edit Income</h2>
            ...
            <form action="{{ route('incomes.update', $income) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="form-control">
                        ...
                        <input type="datetime-local" name="transacted_at" id="transacted_at"
                               value="{{ old('transacted_at', $income->transacted_at->format('Y-m-d\TH:i')) }}"
                ...
                <x-tag-selector :tags="$tags" :selected="$income->tags->pluck('id')->toArray()" />
