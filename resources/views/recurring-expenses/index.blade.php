                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex justify-end gap-2">
                                            <a href="{{ route('recurring-expenses.show', $recurringExpense) }}" class="btn btn-ghost btn-sm">
                                                View
                                            </a>
                                            <a href="{{ route('recurring-expenses.edit', $recurringExpense) }}" class="btn btn-ghost btn-sm">
                                                Edit
                                            </a>
