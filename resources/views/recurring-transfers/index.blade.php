                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex justify-end gap-2">
                                            <a href="{{ route('recurring-transfers.show', $recurringTransfer) }}" class="btn btn-ghost btn-sm tooltip" data-tip="View">
                                                <x-icons.eye class="size-4" />
                                            </a>
                                            <a href="{{ route('recurring-transfers.edit', $recurringTransfer) }}" class="btn btn-ghost btn-sm tooltip" data-tip="Edit">
                                                <x-icons.pencil-square class="size-4" />
                                            </a>
                                            <x-confirm-delete :action="route('recurring-transfers.destroy', $recurringTransfer)" message="Are you sure you want to delete this recurring transfer?" class="btn btn-ghost btn-sm text-error tooltip" data-tip="Delete">
