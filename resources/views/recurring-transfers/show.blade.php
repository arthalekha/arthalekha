        ...
        <div class="card-body">
            <div class="flex justify-between items-start">
                ...
                <div class="flex gap-2">
                    ...
                    <x-confirm-delete :action="route('recurring-transfers.destroy', $recurringTransfer)" message="Are you sure you want to delete this recurring transfer?" class="btn btn-ghost btn-sm text-error">
                        Delete
                    </x-confirm-delete>
                </div>
            </div>
