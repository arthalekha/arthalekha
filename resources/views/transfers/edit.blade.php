            ...
            <form action="{{ route('transfers.update', $transfer) }}" method="POST">
                ...
                <div class="form-control mb-4">
                    ...
                    <x-searchable-select
                        ...
                        :selected="old('debtor_id', $transfer->debtor_id)"
                ...
                <div class="form-control mb-4">
                    ...
                    <x-searchable-select
                        name="creditor_id"
                        :options="$accounts->map(fn($account) => ['value' => $account->id, 'label' => $account->label])->toArray()"
                        :selected="old('creditor_id', $transfer->creditor_id)"
                ...
                <x-tag-selector :tags="$tags" :selected="$transfer->tags->pluck('id')->toArray()" />
