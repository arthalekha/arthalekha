...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <form action="{{ route('transfers.export') }}" method="POST" class="inline">
                @csrf
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex justify-end gap-2">
                                            ...
                                            <a href="{{ route('transfers.edit', $transfer) }}" class="btn btn-ghost btn-sm tooltip" data-tip="Edit">
                                                <x-icons.pencil-square class="size-4" />
                                            </a>
                                            <x-confirm-delete :action="route('transfers.destroy', $transfer)" message="Are you sure you want to delete this transfer?" class="btn btn-ghost btn-sm text-error tooltip" data-tip="Delete">
