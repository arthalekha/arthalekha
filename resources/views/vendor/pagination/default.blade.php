    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}">
        <div class="join">
            ...
            @if ($paginator->onFirstPage())
                <span class="join-item btn btn-disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                    &lsaquo;
                </span>
            @else
            ...
            @else
                <span class="join-item btn btn-disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                    &rsaquo;
                </span>
            @endif
        </div>
